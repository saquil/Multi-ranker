...
Standard ranker learns a ranking function <img src="https://render.githubusercontent.com/render/math?math=R"> that associates high ranking scores to important video segments so that a summary can be built by selecting the top-ranked segments.
